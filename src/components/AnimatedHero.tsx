...
const AnimatedHero: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      >
        <div className="text-white text-6xl font-bold">Smart</div>
      ...
      >
        <div className="text-white text-6xl font-bold">Natural</div>
      ...
      <div className={`relative z-10 flex items-center justify-center min-h-screen transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="text-center px-4 max-w-6xl mx-auto">
          ...
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-black text-white mb-6">
            <span className="inline-block animate-fadeInUp">Transform</span>{' '}
            <span className="inline-block animate-fadeInUp" style={{ animationDelay: '0.1s' }}>Your</span>{' '}
            <span className="inline-block animate-fadeInUp text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-orange-400" style={{ animationDelay: '0.2s' }}>Healthcare</span>
            <br />
          ...
          <p className="text-xl md:text-2xl lg:text-3xl text-white/90 mb-12 max-w-4xl mx-auto leading-relaxed animate-fadeInUp" style={{ animationDelay: '0.5s' }}>
            ...
            <span className="font-bold text-yellow-300">Natural</span>, with{' '}
